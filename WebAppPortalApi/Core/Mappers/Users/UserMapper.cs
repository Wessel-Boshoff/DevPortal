...
namespace WebAppPortalApi.Core.Mappers.Users
{
    internal static class UserMapper
    {
        ...
        internal static User Map(this Data.Database.Tables.dbo.User entity) => entity == default ? new() : new()
        {
        ...
        internal static Data.Database.Tables.dbo.User MapAdd(this User model) => model == default ? new() : new()
        {
            Created = DateTime.Now,
            EmailAddress = model.EmailAddress,
            FirstNames = model.FirstNames,
            LastName = model.LastName,
            RegistrationStatus = RegistrationStatus.NeedPassword,
            Role = model.Role,
        };
